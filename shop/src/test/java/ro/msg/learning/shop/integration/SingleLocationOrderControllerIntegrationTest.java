...
class SingleLocationOrderControllerIntegrationTest {
    ...
    void testCreateOrder_withEnoughStock_shouldCreateOrder() throws Exception {
        ...
        var products = List.of(
                OrderDetailDto.builder().productId(rtx3080.getId()).quantity(6).build(),
        ...
        orderDto.getOrderedProducts().forEach(orderDetailDto -> assertThat(orderDetailDto.getLocationId()).isEqualTo(amazon.getId()));
    }
